...
const MOONR_RATE = 4273.5; // 1 SOL = 4,273.5 MOONR
...
export default function Buy() {
  ...
  // Get current amount as number, fallback to 0
  const getCurrentAmount = () => {
    const num = parseFloat(customAmount);
    return isNaN(num) ? 0 : num;
  };

  // Calculate MOONR tokens
  const calculateMOONR = (solAmount) => {
    if (!solAmount || solAmount <= 0) return 0;
    return (solAmount * MOONR_RATE).toLocaleString(undefined, {
  ...
  const handleBuy = (e) => {
    e.preventDefault();
    setSubmitted(true);
    // Here you would integrate wallet/payment logic
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-purple-500 to-blue-500 text-white font-bold rounded-lg shadow-lg hover:from-purple-400 hover:to-blue-400 transition"
              disabled={getCurrentAmount() < 0.001}
            >
              Buy {calculateMOONR(getCurrentAmount())} MOONR
            </button>
            {submitted && (
              <div className="mt-4 text-green-400 text-center">
                Purchase submitted! (Demo only)
              </div>
            )}
          ...
          <div className="bg-gradient-to-br from-purple-900/40 via-blue-900/40 to-purple-900/40 backdrop-blur-xl rounded-2xl border border-purple-500/30 shadow-2xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-white font-mono">750,000,000 MOONR</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="bg-gradient-to-br from-green-900/40 via-emerald-900/40 to-green-900/40 backdrop-blur-xl rounded-2xl border border-green-500/30 shadow-2xl p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                <span className="text-green-400 mt-1">✓</span>
                <div>
                  <div className="text-white font-medium">Orb Interactions</div>
                  <div className="text-gray-400 text-sm">
